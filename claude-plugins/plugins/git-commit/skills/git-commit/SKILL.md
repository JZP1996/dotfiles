---
name: git-commit
description: Analyze code changes and generate a single Conventional Commits message. Use when the user asks for a commit message, asks to "write a commit", or asks how to commit a set of changes.
---
