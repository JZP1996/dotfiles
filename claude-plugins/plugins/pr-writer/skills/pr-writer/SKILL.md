---
name: pr-writer
description: Compare the current branch against the main branch and produce a PR title and description in Conventional Commits style. Use when the user asks to "write a PR", "draft a pull request", "generate PR description", or is about to open a PR.
---
